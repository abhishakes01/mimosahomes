            ...
            <div className="bg-white p-4 rounded-b-lg flex flex-col md:flex-row gap-4 items-center">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 flex-1 w-full">
                    ...
                    <div className="relative">
                        ...
                        <select className="w-full p-2 border-b border-gray-200 font-semibold text-mimosa-dark focus:outline-none focus:border-mimosa-dark bg-transparent">
                ...
                <button className="bg-mimosa-dark hover:bg-black text-white p-4 rounded-lg transition-colors flex items-center justify-center min-w-[60px]">
                    <Search size={24} />
                </button>
            </div>
        </div>
